<x-card>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 soft-scrollbar">
        ...
        <x-input label="Type Name" placeholder="Enter team type name" wire:model="name" />
    ...
    <x-slot name="footer">
        <div class="flex justify-end gap-x-4">
            <div class="flex justify-between gap-x-2">
                ...
                @if ($actionType == 'add')
                    <x-button positive spinner="addTeamType" label="Add Team Type" wire:click="addTeamType" />
                @elseif ($actionType == 'edit')
                    <x-button positive label="Save Changes" spinner="updateTeamType" wire:click="updateTeamType" />
                @endif
            </div>
        </div>
    </x-slot>
